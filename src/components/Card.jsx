  ...
  return !products || products.length === 0 ? (
    ...
    <div className="w-full h-full p-10 bg-white flex flex-wrap justify-center gap-8 overflow-y-auto">
      {products.map((product, key) => (
        <div key={product.id} className="bg-transparent hover:bg-slate-200 hover:scale-105 transition-transform hover:shadow-md border-black border w-[14%] h-64 p-2 flex flex-col rounded-md">
          <img
